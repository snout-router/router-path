...
export type NormalizeParam<P extends ParamOrString> = P extends string
  ? Param<P>
  : Cast<P, AnyParam>;
 ...
 * accept "undefined"
 */
type AllowOmitUndefined<Type extends Record<string, any>> = {
 ...
 */
type RequiredKeys<Type extends Record<string, any>> = {
 ...
 */
type OptionalKeys<Type extends Record<string, any>> = {
